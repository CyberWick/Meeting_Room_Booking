...
<html>
    ...
    <div id = "maindiv" align="center" style="background-color: white;opacity: 0.9;width: 1100px;height: 400px;display: block;margin-right: auto;margin-left: auto;" >
      ...
      <div id="table_place">
      <table border="1" align="center" style="left: 175px;" id="time-table">
      ...
      <script>
        $(document).ready(function(){
          $("#daybut").click(function(){
            ...
            var dayname = $("#day").val();
            $("#inCaption").append("Time-Table for " + dayname);
            $("$div9").html("<xsl:value-of select="\week\day[@id=Monday]\duration[@start-time=9]\bookedby"/>");
            //$("#dayname").append(dayname);  
            //<strong>$('#day').val()</strong>
          });
        });
      </script>    
     </body>
